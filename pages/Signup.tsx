...
const Signup: React.FC = () => {
  ...
  const getStepMessage = () => {
    switch(step) {
      case 1: return "أهلاً بكِ! أنا هنا لمساعدتكِ. لنبدأ بإدخال اسمكِ ورقمكِ لنبقى على تواصل دائم ✨";
      case 2: return "رائع! الآن أخبريني قليلاً عن بياناتكِ الصحية لنقدم لكِ نصائح دقيقة تناسب جسمكِ 🌸";
      case 3: return "ما هي حالتكِ الاجتماعية؟ هذا يساعدني في تخصيص المحتوى المناسب لكِ تماماً 💖";
      case 4: return "أخيراً، دعينا ننظم دورتكِ الشهرية. نحن هنا لراحتكِ في كل يوم من الشهر! 🥰";
      default: return "";
    }
  };
